...
//@UIApplicationMain
class BoostAppDelegate: UIResponder, UIApplicationDelegate {
    var window: UIWindow?
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]? = nil) -> Bool {
        ...
        FlutterBoost.instance().setup(application, delegate: delegate, callback: { _ in
        ...
        sendEventButton.snp.makeConstraints { mkr in
            ...
            mkr.top.equalToSuperview().offset(400)
        }
    ...
    @objc func onTapSendEventButton() {
        // 发送自定义事件
        FlutterBoost.instance().sendEventToFlutter(with: "toFlutterEvent", arguments: ["data": "event from native"])
    }
}
